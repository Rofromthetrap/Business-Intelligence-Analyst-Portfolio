...
Welcome to my Business Intelligence Analyst Portfolio! This document provides a comprehensive overview of my skills, projects, and Power BI dashboards.
...
4. [**Snowflake SuperStore Sales**](Power%20BI/snowflake_super_store_sales/)  
   Sales analytics dashboard powered by Snowflake data.

## Python Projects

### Cryptocurrency Analysis
- [BTC USD Daily Analysis](Python/crypto/BTC_USD_Daily.ipynb)
- [Correlation Analysis](Python/crypto/Correlation%20Analysis.ipynb)
- [Crypto Test](Python/crypto/crypto_test.ipynb)

### Snowflake & dbt Data Pipeline
- [Super Store Sales dbt Project](Python/py_snowflake/super_store_sales/)

## Skills

- **Data Visualization:** Proficient in Power BI, and Excel
- **Database Management:** Experienced in SQL and Snowflake
- **Data Analysis:** Strong analytical skills utilizing Python
- **Data Engineering:** Proficient in dbt for data transformation and modeling
- **Business Intelligence:** Knowledgeable in BI tools and methodologies to drive business insights

Feel free to explore my projects and dashboards, and reach out for any inquiries!
